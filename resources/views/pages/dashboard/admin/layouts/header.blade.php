                                ...
                                <div aria-labelledby="hs-dropdown-hover-event-lang"
                                    ...
                                    <div class="message-body max-h-[200px]">
                                        <a href="javascript:void(0)"
                                            ...
                                            <div class="flex gap-3 items-center">
                                                <span class="flex-shrink-0">
                                                    <img src="../assets/images/svgs/icon-flag-en.svg" alt="user"
                                        ...
                                        <a href="javascript:void(0)"
                                            ...
                                            <div class="flex gap-3 items-center">
                                                <span class="flex-shrink-0">
                                                    <img src="../assets/images/svgs/icon-flag-cn.svg" alt="user"
                                                        class="object-cover w-5 h-5 rounded-full">
                                                </span>
                                                <span
                                        ...
                                        <a href="javascript:void(0)"
                                            ...
                                            <div class="flex gap-3 items-center">
                                                <span class="flex-shrink-0">
                                                    <img src="../assets/images/svgs/icon-flag-fr.svg" alt="user"
                                                        class="object-cover w-5 h-5 rounded-full">
                                                </span>
                                                <span
                                        ...
                                        <a href="javascript:void(0)"
                                            ...
                                            <div class="flex gap-3 items-center">
                                                <span class="flex-shrink-0">
                                                    <img src="../assets/images/svgs/icon-flag-sa.svg" alt="user"
                                                        class="object-cover w-5 h-5 rounded-full">
                                                </span>
                                                <span
                                            ...
                                            <div class="">
                                                <div class="flex items-center">
                                                    <img src="../assets/images/profile/user-1.jpg"
                                                        class="h-20 w-20 rounded-full object-cover" alt="profile">
                                                ...
                                                <div
                                                    class="p-5 rounded-md bg-lightprimary dark:bg-darkprimary overflow-hidden relative">
                                                    ...
                                                    <img src="../assets/images/backgrounds/unlimited-bg.png"
                                                        alt="bg-img" class="absolute right-0 top-0">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-5">
                                    ...
                                    <div id="navbar-offcanvas-example"
                                        ...
                                        <div class="lg:flex gap-2  items-center ">
                                            ...
                                            <div class="lg:p-0 p-5 lg:flex gap-2 items-center">
                                                <div class="lg:flex items-center">
                                                    <div
                                                        ...
                                                        <button type="button"
                                                            class="header-link-btn group-hover/menu:bg-lightprimary group-hover/menu:text-primary">
                                                            <i
                                                                class="ti ti-api-app lg:hidden lg:text-sm text-xl"></i>Apps
                                                            <i
                                                                class="ti ti-chevron-down  ms-auto lg:text-sm text-lg"></i>
                                                        </button>
                                                ...
                                                <div>
                                                    <a href="#"
                                                        class="lg:w-auto w-full lg:py-1 lg:px-3 py-2 px-3 lg:text-sm text-md flex  lg:gap-0 gap-3 header-link text-link dark:text-darklink  items-center hover:text-primary light-dark-hoverbg  rounded-md">
                                                        <i
                                                            class="ti ti-message-dots lg:hidden lg:text-sm text-xl"></i>Chat</a>
                                                </div>
                                                <div>
                                                    <a href="#"
                                                        class="lg:w-auto w-full lg:py-1 lg:px-3 py-2 px-3 lg:text-sm text-md flex  lg:gap-0 gap-3  header-link text-link dark:text-darklink  items-center hover:text-primary light-dark-hoverbg  rounded-md">
                                                        <i
                                                            class="ti ti-calendar lg:hidden lg:text-sm text-xl"></i>Calender</a>
                                                </div>
                                                <div>
                                                    <a href="#"
                                                        class="lg:w-auto w-full lg:py-1 lg:px-3 py-2 px-3 lg:text-sm text-md flex  lg:gap-0 gap-3   header-link text-link dark:text-darklink  items-center hover:text-primary light-dark-hoverbg rounded-md">
                                                        <i
                                                            class="ti ti-mail lg:hidden lg:text-sm text-xl"></i>Email</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <ul class="mt-10">
                                                            ...
                                                            <li class="mb-5">
                                                                <a href="../main/app-email.html"
                                                                    ...
                                                                    <div class="">
                                                                        <h6
                                                                            class="fext-sm mb-1  group-hover:text-primary ">
                                                                            My Inbox
                                                                        </h6>
                                                                        <p
                                                                            class="text-xs text-link dark:text-darklink font-normal">
