            ...
            <div class="flex items-center grid grid-cols-12 gap-6">
                <div class="col-span-9">
                    ...
                    <ol class="flex items-center whitespace-nowrap" aria-label="Breadcrumb">
                        ...
                        <li class="inline-flex items-center">
                            <a class="flex items-center text-sm text-gray-500 hover:text-primary focus:outline-none focus:text-primary dark:focus:text-primary leading-tight" href="{{ route('customer.checkups.index') }}">
                ...
                <div class="col-span-3">
                    <div class="flex justify-end">
                        <a href="{{ route('customer.checkups.index') }}" class="btn btn-secondary">
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 md:col-span-8">
            ...
            <div class="card mt-6">
                <div class="card-body">
                    <h3 class="card-title mb-4 flex items-center">
                        <i class="ti ti-brain text-xl mr-2"></i> {{ __('app.diet_program_prediction') }}
                    </h3>
