            ...
            <div class="flex items-center grid grid-cols-12 gap-6">
                <div class="col-span-9">
                    ...
                    <ol class="flex items-center whitespace-nowrap" aria-label="Breadcrumb">
                        ...
                        <li class="inline-flex items-center">
                            <a class="flex items-center text-sm text-gray-500 hover:text-primary focus:outline-none focus:text-primary dark:focus:text-primary leading-tight" href="{{ route('customer.diet-recommendations.index') }}">
                ...
                <div class="col-span-3">
                    <div class="flex justify-end gap-2">
                        <a href="{{ route('customer.diet-recommendations.index') }}" class="btn btn-secondary">
                    ...
                    <div class="space-y-4">
                        <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded">
                            ...
                            <div class="text-lg font-semibold text-dark dark:text-white">
                                {{ $recommendation->checkup->programEnrollment->user->name ?? 'N/A' }}</div>
                        </div>

                        <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded">
                            <div class="text-sm text-gray-500 dark:text-gray-400">{{ __('app.checkup_date') }}</div>
                            <div class="text-dark dark:text-white">
                                {{ $recommendation->checkup->checkup_date->format('d M Y') }}</div>
                        </div>
        ...
        <div class="col-span-12 md:col-span-8">
            <div class="card">
                <div class="card-body">
                    ...
                    @if (session('success'))
                        <div class="bg-lightsuccess dark:bg-darksuccess text-success px-4 py-3 rounded relative mb-4"
                            role="alert">
