    ...
    <div class="w-full px-5 py-5">
        ...
        <div class="col-span-12">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div class="flex justify-center">
                                <img src="./assets/images/svgs/icon-user-male.svg" width="40" height="40" class="mb-3"
                                    alt>
                            </div>
                ...
                <div
                    class="card mb-0 shadow-none bg-lighterror dark:bg-darkerror w-full transition duration-300 hover:shadow-lg">
                    <div class="card-body">
                        <div class="text-center">
                            <div class="flex justify-center">
                ...
                <div class="lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div id="diet-program-chart" class="my-8" data-weight-gain="{{ $weightGainCount }}"
                                data-weight-loss="{{ $weightLossCount }}" data-fat-loss="{{ $fatLossCount }}">
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle">
                                {{ __('app.customer_bmi_categories') ?? 'Customer distribution across BMI categories' }}
                            </p>
                            ...
                            <div class="flex flex-wrap gap-4 mb-4 mt-4">
                                <div class="w-full md:w-1/3 lg:w-1/4">
                                    <label for="programFilter"
                                        class="block text-sm font-medium text-gray-700 mb-1">{{ __('app.filter_by_program') }}</label>
                                ...
                                <div class="w-full md:w-1/3 lg:w-1/4">
                                    <label for="customerFilter"
                                        class="block text-sm font-medium text-gray-700 mb-1">{{ __('app.select_customer') }}</label>
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">
                                {{ __('app.program_status_distribution') ?? 'Program Status Distribution' }}</h5>
                            <p class="card-subtitle">
                                {{ __('app.program_status_summary') ?? 'Summary of program enrollment statuses' }}</p>
                ...
                <div class="lg:col-span-6 md:col-span-6 sm:col-span-12 col-span-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle">
                                {{ __('app.age_distribution_summary') ?? 'Age groups of customers enrolled in diet programs' }}
                            </p>
                            <div id="age-distribution-chart" class="my-8"
                                ...
                                data-detailed-breakdown='{{ json_encode($ageDetailedBreakdown ?? []) }}'>
                            </div>
                        </div>
                    </div>
                </div>
