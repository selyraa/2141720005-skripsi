                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="mb-4">
                                ...
                                <input type="number" id="height" name="height" min="100" max="250" step="0.1"
                                       value="{{ old('height', $checkup->height) }}" class="form-control w-full" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="weight" name="weight" min="30" max="200" step="0.1"
                                       value="{{ old('weight', $checkup->weight) }}" class="form-control w-full" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="body_fat" name="body_fat" min="0" max="100" step="0.1"
                                       value="{{ old('body_fat', $checkup->body_fat) }}" class="form-control w-full" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="belly_fat" name="belly_fat" min="0" max="100" step="0.1"
                                       value="{{ old('belly_fat', $checkup->belly_fat) }}" class="form-control w-full" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="muscle_mass" name="muscle_mass" min="0" max="100" step="0.1"
                                       value="{{ old('muscle_mass', $checkup->muscle_mass) }}" class="form-control w-full" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="bone_density" name="bone_density" min="0" max="100" step="0.1"
                                       value="{{ old('bone_density', $checkup->bone_density) }}" class="form-control w-full" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="water_content" name="water_content" min="0" max="100" step="0.1"
                                       value="{{ old('water_content', $checkup->water_content) }}" class="form-control w-full" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="calories_needs" name="calories_needs" min="500" max="5000" step="1"
                                       value="{{ old('calories_needs', $checkup->calories_needs) }}" class="form-control w-full" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="cell_age" name="cell_age" min="1" max="120" step="1"
                                       value="{{ old('cell_age', $checkup->cell_age) }}" class="form-control w-full" required>
                            </div>
                        </div>
