            ...
            <div class="flex items-center grid grid-cols-12 gap-6">
                ...
                <div class="col-span-3">
                    <div class="flex justify-end">
                        <a href="{{ route('diet-recommendations.show', $recommendation->id) }}" class="btn btn-secondary">
        ...
        <div class="col-span-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('diet-recommendations.update', $recommendation->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex justify-end mt-6">
                            <a href="{{ route('diet-recommendations.show', $recommendation->id) }}" class="btn btn-secondary me-2">
