                    ...
                    <form action="{{ route('diet-programs.update', $dietProgram->id) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $dietProgram->name) }}" class="form-control w-full @error('name') border-error @enderror" required>
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" rows="4" class="form-control w-full @error('description') border-error @enderror">{{ old('description', $dietProgram->description) }}</textarea>
                                @error('description')
                                    <div class="text-error text-sm mt-1">{{ $message }}</div>
                                @enderror
                            </div>
